 ...
 */
class STestAdapter(m_onClickItemListener: OnClickItemListener<SCarrierInvoiceHeaderDTO>) : SBaseRecyclerViewAdapter<SCarrierInvoiceHeaderDTO>(m_onClickItemListener) {
