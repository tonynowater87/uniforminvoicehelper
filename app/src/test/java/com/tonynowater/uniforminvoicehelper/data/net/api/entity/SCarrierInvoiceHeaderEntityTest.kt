 ...
 */
class SCarrierInvoiceHeaderEntityTest {
    ...
    @Test
    fun getV() {
        entity = gson.fromJson(json_200, SCarrierInvoiceHeaderEntity::class.java)
    ...
    @Test
    fun isNot200() {
        entity = gson.fromJson(json_400, SCarrierInvoiceHeaderEntity::class.java)
