 ...
 */
class SInvAppPrizeNumListEntityTest {
    ...
    @Test
    fun getV() {
        entity = gson.fromJson(json_200, SInvAppPrizeNumListEntity::class.java)
    ...
    @Test
    fun isNot200() {
        entity = gson.fromJson(json_400, SInvAppPrizeNumListEntity::class.java)
